...
legge da terminale tre numeri interi positivi e
stampa il fattoriale dei tre numeri. La funzione
stampa_fattoriale_ric deve utilizzare la funzione fattoriale_ric.
...
let rec f (x : int) (y : char) : int =
    if (x > 0) then
        ...
        0
Scrivere una funzione stampa_f che acquisisce un
intero x e un carattere y e stampa sul terminale il
risultato della applicazione della funzione f ai valori x e y.
...
Scrivere la funzione iterativa stampa_fattoriale_ite
che legge un numero intero positivo da terminale e
stampa il fattoriale del numero inserito. La funzione
non deve utilizzare la funzione fattoriale_ric precedentemente implementata.
